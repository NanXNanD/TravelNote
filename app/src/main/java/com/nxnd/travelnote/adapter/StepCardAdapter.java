...
public class StepCardAdapter extends ArrayAdapter<StepModel> {

    private int newResourceId;

    public StepCardAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        //控件
        TextView date = view.findViewById(R.id.step_card_date);
        TextView location = view.findViewById(R.id.step_card_location);
        TextView content = view.findViewById(R.id.step_card_content);
        ImageView img = view.findViewById(R.id.step_card_img);
